...
public class MD5Util {
     ...
     * @return
     */
    public static String getMD5String(String s, String charset) throws UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    public static String getFileMD5StringOld(File file) throws IOException, NoSuchAlgorithmException {
        MessageDigest messagedigest = MessageDigest.getInstance("MD5");
